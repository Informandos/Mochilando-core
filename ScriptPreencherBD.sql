-- Atração
insert into atracao (cod_cidade_atracao, cod_tipo_atracao, nom_atracao, nro_latitude, nro_longitude) values (select cod_cidade from cidade where nom_cidade like 'Belo Horizonte', select cod_tipo_atracao from tipo_atrcao where desc_tipo_atracao like 'Praça', 'Praça da Liberdade', 1, 1);
...
-- Comentário
insert into comentario (cod_diario, cod_autor_comentario, dat_publicacao, txt_comentario) values (select cod_diario from diario where nom_diario like 'Viagem à Belo Horizonte-MG', select cod_usuario from usuario where cod_usuario = 3, '2018-05-06', 'Que legal');
insert into comentario (cod_diario, cod_autor_comentario, dat_publicacao, txt_comentario) values (select cod_diario from diario where nom_diario like 'Viagem à São Paulo-SP', select cod_usuario from usuario where cod_usuario = 1, '2018-06-05', 'Top');
insert into comentario (cod_diario, cod_autor_comentario, dat_publicacao, txt_comentario) values (select cod_diario from diario where nom_diario like 'Viagem ao Rio de Janeiro-RJ', select cod_usuario from usuario where cod_usuario = 2, '2018-04-08', 'Que bonito');
...
-- Diário
insert into diario (cod_usuario, nom_diario, dat_publicacao, dat_inicio_viagem, dat_fim_viagem, txt_diario) values (select cod_usuario from usuario where cod_usuario = 1, 'Viagem à Belo Horizonte-MG', '2018-05-05', '2018-05-05', '2018-05-12');
insert into diario (cod_usuario, nom_diario, dat_publicacao, dat_inicio_viagem, dat_fim_viagem, txt_diario) values (select cod_usuario from usuario where cod_usuario = 2, 'Viagem à São Paulo-SP', '2018-06-04', '2018-06-04', '2018-06-11');
insert into diario (cod_usuario, nom_diario, dat_publicacao, dat_inicio_viagem, dat_fim_viagem, txt_diario) values (select cod_usuario from usuario where cod_usuario = 3, 'Viagem ao Rio de Janeiro-RJ', '2018-04-07', '2018-04-07', '2018-04-14');
