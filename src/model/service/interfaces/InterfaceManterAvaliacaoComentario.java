...
public interface InterfaceManterAvaliacaoComentario {
    ...
    public Long cadastrar(AvaliacaoComentario avaliacaoComenario) throws ExcecaoPersistencia, ExcecaoNegocio;
    public boolean alterar(AvaliacaoComentario avaliacaoComenario) throws ExcecaoPersistencia, ExcecaoNegocio;
    public boolean excluir(AvaliacaoComentario avaliacaoComenario) throws ExcecaoPersistencia, ExcecaoNegocio;
